...
date: "2026-02-22"
summary: "I tested a dead-simple trick from a Google Research paper -just repeat the prompt -on small open-source models. On ARC-Challenge, accuracy doubled."
---
...
The paper's wildest result was on NameIndex -find a specific name in a list of 50 random names. Large models went from 21% to 97% with repetition.
